...
public class SocialAuth {
    ...
    @FindBy(xpath = "//div[@class='btn btn_block btn_enter']")
    WebElement enterButtonAfterLoadUnAuthorizedLobby;

    @FindBy(xpath = "//div[@data-page='enter']//div[@data-social='fb']")
