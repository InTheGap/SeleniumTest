...
public class UnauthorisedLobby {
    ...
    @FindBy(xpath = "//div[@class='button_inner']/span[@data-lang_id='enter']")
    WebElement enterButtonAfterLoadUnAuthorizedLobby;

    @FindBy(xpath = "//div[@class='button_inner']/span[@data-lang_id='registration']")
    ...
    @FindBy(xpath = "//div[@data-lang_id='toRegistred']")
