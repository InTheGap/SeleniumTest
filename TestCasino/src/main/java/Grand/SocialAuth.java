...
public class SocialAuth {
    ...
    @FindBy(xpath = "//div[@class='tab auth_tab u_6_12']//div[@class='button_social' and @data-name='fb']")
    WebElement authorizationFbButton;

    @FindBy(xpath = "//div[@class='tab auth_tab u_6_12']//div[@class='button_social' and @data-name='mm']")
    WebElement authorizationMmButton;

    @FindBy(xpath = "//div[@class='tab auth_tab u_6_12']//div[@class='button_social' and @data-name='ok']")
    WebElement authorizationOkButton;

    @FindBy(xpath = "//div[@class='tab auth_tab u_6_12']//div[@class='button_social' and @data-name='vk']")
